...
```
 ...
 Правильная схема ![stand-plan](stand-plan.png) к заданию. Было решено освоить distributed gateway, когда шлюз для каждого домена находится на каждом leaf. Возникли нюансы с обменом маршрутной информацией между vrf leaf-4 и r-1, но об этом позже, ~~выстраданый~~ ![конфиг файл](./topology.yml)
или под катом
